...
module instructions_tb ();
    ...
    task automatic expect_reg(int r, logic [31:0] expected, string message);
        logic [31:0] found = soc_inst.processor_inst.registerFile[r];
    ...
    initial begin
        ...
        soc_inst.bram_inst.memory[WORD_0] = 32'h123450b7;
        soc_inst.bram_inst.memory[WORD_4] = 32'h02a00113;
        soc_inst.bram_inst.memory[WORD_8] = 32'h03212193;
